...
public final class JasoFilter extends TokenFilter {
    ...
    public JasoFilter(TokenStream input) {
        this(input, true);
    }
     ...
     */
    public JasoFilter(TokenStream input, boolean bigram) {
        this(input, bigram, false);
    }

    public JasoFilter(TokenStream input, boolean bigram, boolean has) {
        this(input, bigram, has, false);
    }

    public JasoFilter(TokenStream input, boolean bigram, boolean has, boolean exactMatch) {
        this(input, bigram, has, exactMatch, true);
    }

    public JasoFilter(TokenStream input, boolean bigram, boolean has, boolean exactMatch, boolean cnoun) {
...
//    	this.morph.setDivisibleOne(false);
    ...
    public boolean incrementToken() throws IOException {
        ...
        while (input.incrementToken()) {
            ...
            String term = JasoTokenizer.getInstance().jasoTokenizer(termAtt.toString());
...
//	input = trimHangul(input);
        ...
        for (KoreanToken kt : values) {
            kt.setTerm(JasoTokenizer.getInstance().jasoTokenizer(kt.getTerm()));
